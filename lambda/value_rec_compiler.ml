...
let compute_static_size lam =
  let rec compute_expression_size env lam =
    ...
    | Lextswitch _ ->
        Misc.fatal_error "Value_rec_compiler.compute_static_size: uninitialized extswitch"
...
let rec split_static_function block_var local_idents lam :
  ...
  | Lextswitch _ ->
      Misc.fatal_error "Value_rec_compiler.split_static_function: uninitialized extswitch"
